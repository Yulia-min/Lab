...
namespace lab3
{
    public partial class Form1 : Form
    {
        ...
        private void СуммаToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            var result = AonedimensionalArray.GetCollectionFromDataGridView(dataGridView1);
            var sum = AonedimensionalArray.Sum(result);
            MessageBox.Show($"сумма:{sum}", "Сумма", MessageBoxButtons.OK);
        }
